...
<div style={{ padding: "2rem", textAlign: "center" }}>
      <p style={{color:"black"}} id="message">Redirecting...</p>
    </div>
</>
  return (
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        ...
        <div style={styles.headerContent}>
          <div style={styles.logoIcon} className="floating-animation glow-effect">
            🔧
          </div>
          <h1 style={styles.mainTitle} className="gradient-text">LocalSe</h1>
      ...
      <section style={styles.servicesSection}>
        <div style={styles.sectionHeader}>
          ...
          <p style={styles.sectionSubtitle}>आपके आस-पास के trusted professionals से जुड़ें</p>
        </div>
        
        <div style={styles.servicesGrid}>
          {[
            { name: 'Electrician', icon: '⚡', color: 'linear-gradient(135deg, #ffa726, #ff9800)' },
            { name: 'Plumber', icon: '🔧', color: 'linear-gradient(135deg, #42a5f5, #2196f3)' },
            { name: 'Carpenter', icon: '🔨', color: 'linear-gradient(135deg, #ffb74d, #ff9800)' },
            { name: 'AC Repair', icon: '❄️', color: 'linear-gradient(135deg, #29b6f6, #03a9f4)' },
            { name: 'Painter', icon: '🎨', color: 'linear-gradient(135deg, #ab47bc, #9c27b0)' },
            { name: 'Cleaning', icon: '🧹', color: 'linear-gradient(135deg, #66bb6a, #4caf50)' },
            { name: 'Mechanic', icon: '🔧', color: 'linear-gradient(135deg, #78909c, #607d8b)' },
            { name: 'और भी...', icon: '➕', color: 'linear-gradient(135deg, #5c6bc0, #3f51b5)' }
          ].map((service, index) => (
            <div 
              key={index} 
            ...
            >
              <div style={{...styles.serviceIcon, background: service.color}} className="morphing-blob">
                {service.icon}
              </div>
      ...
      <section style={styles.featuresSection}>
        ...
        <div style={styles.featuresGrid}>
          <div style={styles.featureCard} className="slide-in-left">
            <div style={{...styles.featureIcon, background: 'linear-gradient(135deg, #66bb6a, #4caf50)'}} className="glow-effect">
              📍
            </div>
            <h3 style={styles.featureTitle}>आस-पास के Professionals</h3>
            <p style={styles.featureDescription}>
              आपके area के verified और trusted service providers से तुरंत connect करें।
            </p>
          </div>
          
          <div style={styles.featureCard} className="slide-in-right">
            <div style={{...styles.featureIcon, background: 'linear-gradient(135deg, #42a5f5, #2196f3)'}} className="glow-effect">
              ⏰
            </div>
          ...
          <div style={styles.featureCard} className="slide-in-left">
            <div style={{...styles.featureIcon, background: 'linear-gradient(135deg, #ffa726, #ff9800)'}} className="glow-effect">
              ⭐
            </div>
            <h3 style={styles.featureTitle}>Rated Professionals</h3>
            <p style={styles.featureDescription}>
              Genuine reviews और ratings के साथ best professionals को choose करें।
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={styles.howItWorksSection}>
        ...
        <div style={styles.stepsGrid}>
          {[
            { step: '1', title: 'Service Select करें', desc: 'जो service चाहिए वो choose करें' },
            { step: '2', title: 'Professional मिलेगा', desc: 'आपके area का best professional assign होगा' },
            { step: '3', title: 'Work Complete', desc: 'Quality service guarantee के साथ' }
          ].map((item, index) => (
            <div key={index} style={styles.stepCard} className="floating-animation">
