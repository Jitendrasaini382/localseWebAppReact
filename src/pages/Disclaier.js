        ...
        <Row className="w-100">
          <Col lg={10} className="mx-auto">
            <div className="bg-dark bg-opacity-50 rounded-3 p-5 shadow">
              <h1 className="display-6 text-center mb-4">LocalSe Disclaimer</h1>
                ...
                <ul className="list-unstyled">
                  <li className="mb-3 d-flex align-items-start">
                    ...
                    <span className="opacity-75">
                      LocalSe.in does not offer or manage services directly. We
                      provide a platform to connect customers and contractors.
                    </span>
                  </li>
                  <li className="mb-3 d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      We do not endorse or guarantee contractor services. Users
                      are responsible for any risks associated with contractor
                      engagements.
                    </span>
                  </li>
                  <li className="d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      LocalSe.in is not responsible for any disputes, damages,
                      or losses resulting from service engagements. Users agree
                      to accept these risks when using the platform.
                    </span>
                  </li>
                </ul>
              </div>
