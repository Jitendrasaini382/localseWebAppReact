                ...
                <ul className="list-unstyled">
                  <li className="mb-3 d-flex align-items-start">
                    ...
                    <span className="opacity-75">
                      ...
                      details, booking history, and location to improve user
                      experience and facilitate service connections.
                    </span>
                  </li>
                  <li className="mb-3 d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      Data may be shared with contractors for booking
                      fulfillment and with third parties for operational needs,
                      including SMS services, WhatsApp services, server
                      management, payment processing, and Google APIs.
                    </span>
                  </li>
                  <li className="mb-3 d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      ...
                      user data and conduct regular reviews to maintain safety.
                    </span>
                  </li>
                  <li className="mb-3 d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      ...
                      data and can opt out of marketing communications at any
                      time.
                    </span>
                  </li>
                  <li className="d-flex align-items-start">
                    <span className="text-success me-3">•</span>
                    <span className="opacity-75">
                      Cookies are used to enhance the user experience. Users can
                      manage cookie preferences in their browser settings.
                    </span>
                  </li>
                </ul>
              </div>
